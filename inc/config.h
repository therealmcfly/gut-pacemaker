...
#define CHANNEL_RETRIEVAL_VERIFICATION 1
#define DOWNSAMPING_VERIFICATION 1
#define LOW_PASS_FILTER_VERIFICATION 1
#define HIGH_PASS_FILTER_VERIFICATION 1
#define ARTIFACT_REMOVAL_VERIFICATION 1
#define NEO_TRANSFORM_VERIFICATION 1
...
#define ACTIVATION_DETECTION_VERIFICATION 1
